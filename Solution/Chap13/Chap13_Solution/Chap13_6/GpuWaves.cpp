...
void GpuWaves::BuildResources(ID3D12GraphicsCommandList* cmdList)
{
	...
	{
		auto b = CD3DX12_RESOURCE_BARRIER::Transition(mPrevSol.Get(),
	...
	{
		auto b = CD3DX12_RESOURCE_BARRIER::Transition(mCurrSol.Get(),
			D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_COPY_DEST);
		cmdList->ResourceBarrier(1, &b);
	}
	...
	{
		auto b = CD3DX12_RESOURCE_BARRIER::Transition(mNextSol.Get(),
