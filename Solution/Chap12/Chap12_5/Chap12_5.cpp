...
void BlendApp::Draw(const GameTimer& gt)
{
	...
	DrawRenderItems(mCommandList.Get(), mRitemLayer[(int)RenderLayer::DrawNormal]);
...
void BlendApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\..\\Chap12\\Chap12_5\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\..\\Chap12\\Chap12_5\\Shaders\\Default.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"..\\..\\Chap12\\Chap12_5\\Shaders\\Default.hlsl", alphaTestDefines, "PS", "ps_5_0");

	mShaders["drawNormalVS"] = d3dUtil::CompileShader(L"..\\..\\Chap12\\Chap12_5\\Shaders\\DrawNormal.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["drawNormalGS"] = d3dUtil::CompileShader(L"..\\..\\Chap12\\Chap12_5\\Shaders\\DrawNormal.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["drawNormalPS"] = d3dUtil::CompileShader(L"..\\..\\Chap12\\Chap12_5\\Shaders\\DrawNormal.hlsl", nullptr, "PS", "ps_5_0");
