...
private:
	...
	void DrawTrees(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems);
...
void TreeBillboardsApp::Draw(const GameTimer& gt)
{
	...
	DrawTrees(mCommandList.Get(), mRitemLayer[(int)RenderLayer::AlphaTestedTreeSprites]);
...
void TreeBillboardsApp::BuildShadersAndInputLayouts()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\Chap12_6\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\Chap12_6\\Shaders\\Default.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"..\\Chap12_6\\Shaders\\Default.hlsl", alphaTestDefines, "PS", "ps_5_0");
	
	mShaders["treeSpriteVS"] = d3dUtil::CompileShader(L"..\\Chap12_6\\Shaders\\TreeSprite.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["treeSpriteGS"] = d3dUtil::CompileShader(L"..\\Chap12_6\\Shaders\\TreeSprite.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["treeSpritePS"] = d3dUtil::CompileShader(L"..\\Chap12_6\\Shaders\\TreeSprite.hlsl", alphaTestDefines, "PS", "ps_5_0");
...
void TreeBillboardsApp::DrawTrees(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
	UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(ObjectConstants));
	UINT matCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(MaterialConstants));
	...
	for (size_t i = 0; i < ritems.size(); ++i)
	{
		...
		//cmdList->DrawInstanced(16, 1, 0, 0);
