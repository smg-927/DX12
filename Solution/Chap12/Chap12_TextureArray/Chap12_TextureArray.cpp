...
void TreeBillboardsApp::LoadTextures()
{
	...
	auto treeArrayTex1 = std::make_unique<Texture>();
	treeArrayTex1->Name = "treeArrayTex1";
	treeArrayTex1->Filename = L"../../../Textures/treeArray.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
		mCommandList.Get(), treeArrayTex1->Filename.c_str(),
		treeArrayTex1->Resource, treeArrayTex1->UploadHeap));

	mTextures[grassTex->Name] = std::move(grassTex);
	mTextures[waterTex->Name] = std::move(waterTex);
	mTextures[fenceTex->Name] = std::move(fenceTex);
	mTextures[treeArrayTex1->Name] = std::move(treeArrayTex1);
}
...
void TreeBillboardsApp::BuildDescriptorHeaps()
{
	...
	auto treeArrayTex1 = mTextures["treeArrayTex1"]->Resource;
	...
	auto desc = treeArrayTex1->GetDesc();
	srvDesc.ViewDimension = D3D12_SRV_DIMENSION_TEXTURE2DARRAY;
	srvDesc.Format = treeArrayTex1->GetDesc().Format;
	srvDesc.Texture2DArray.MostDetailedMip = 0;
	srvDesc.Texture2DArray.MipLevels = -1;
	srvDesc.Texture2DArray.FirstArraySlice = 0;
	srvDesc.Texture2DArray.ArraySize = treeArrayTex1->GetDesc().DepthOrArraySize;
	md3dDevice->CreateShaderResourceView(treeArrayTex1.Get(), &srvDesc, hDescriptor);
}
