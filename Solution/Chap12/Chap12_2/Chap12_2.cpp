...
void TreeBillboardsApp::BuildShadersAndInputLayouts()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\Chap12_2\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\Chap12_2\\Shaders\\Default.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"..\\Chap12_2\\Shaders\\Default.hlsl", alphaTestDefines, "PS", "ps_5_0");

	mShaders["sphereVS"] = d3dUtil::CompileShader(L"..\\Chap12_2\\Shaders\\Sphere.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["sphereGS"] = d3dUtil::CompileShader(L"..\\Chap12_2\\Shaders\\Sphere.hlsl", nullptr, "GS", "gs_5_0");
	mShaders["spherePS"] = d3dUtil::CompileShader(L"..\\Chap12_2\\Shaders\\Sphere.hlsl", alphaTestDefines, "PS", "ps_5_0");
