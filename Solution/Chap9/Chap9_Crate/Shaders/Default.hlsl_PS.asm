...
//
#line 106 "C:\cg\DX12\Solution\Chap9\Chap9_Crate\Shaders\Default.hlsl"
...
#line 112
   ...
   6: add r2.xyz, r2.xyzx, cb1[24].xyzx
   7: dp3 r1.w, r2.xyzx, r2.xyzx
   8: rsq r1.w, r1.w
   9: mul r2.xyz, r1.wwww, r2.xyzx  // r2.x <- toEyeW.x; r2.y <- toEyeW.y; r2.z <- toEyeW.z
...
#line 117
  11: mov r1.w, -cb2[1].w
  12: add r4.w, r1.w, l(1.000000)  // r4.w <- shininess
...
#line 120
  17: nop 
  18: mov x0[0].xyz, cb1[28].xyzx
  19: mov x0[2].xyz, cb1[29].xyzx
  20: mov x0[4].xyz, cb1[30].xyzx
  21: mov x0[6].xyz, cb1[31].xyzx
  22: mov x0[8].xyz, cb1[32].xyzx
  23: mov x0[10].xyz, cb1[33].xyzx
  24: mov x0[12].xyz, cb1[34].xyzx
  25: mov x0[14].xyz, cb1[35].xyzx
  26: mov x0[16].xyz, cb1[36].xyzx
  27: mov x0[18].xyz, cb1[37].xyzx
  28: mov x0[20].xyz, cb1[38].xyzx
...
#line 147
  34: mov r1.w, l(0)  // r1.w <- i
  35: mov r6.xyz, r0.xyzx  // r6.x <- result.x; r6.y <- result.y; r6.z <- result.z
  36: mov r2.w, r1.w  // r2.w <- i
  37: loop 
  38:   ilt r3.w, r2.w, l(3)
  39:   breakc_z r3.w

#line 149
  40:   mov r3.w, l(1.000000)  // r3.w <- shadowFactor.x
  41:   nop 
  42:   imul null, r4.x, r2.w, l(6)
  43:   mov r7.xyz, x0[r4.x + 0].xyzx
  44:   mov r8.xyz, x0[r4.x + 2].xyzx
  45:   mov r9.x, r5.w
...
#line 70
  51:   dp3 r4.x, r8.xyzx, r11.xyzx
  52:   max r4.x, r4.x, l(0.000000)  // r4.x <- ndotl

#line 71
  53:   mul r7.xyz, r4.xxxx, r7.xyzx  // r7.x <- lightStrength.x; r7.y <- lightStrength.y; r7.z <- lightStrength.z
...
#line 46
  61:   mul r4.x, r9.w, l(256.000000)  // r4.x <- m

#line 47
  62:   add r12.xyz, r8.xyzx, r12.xyzx
  63:   dp3 r6.w, r12.xyzx, r12.xyzx
  64:   rsq r6.w, r6.w
  65:   mul r12.xyz, r6.wwww, r12.xyzx  // r12.x <- halfVec.x; r12.y <- halfVec.y; r12.z <- halfVec.z

#line 49
  66:   add r6.w, r4.x, l(8.000000)
  67:   dp3 r7.w, r12.xyzx, r11.xyzx
  68:   max r7.w, r7.w, l(0.000000)
  69:   log r7.w, r7.w
  70:   mul r4.x, r4.x, r7.w
  71:   exp r4.x, r4.x
  72:   mul r4.x, r4.x, r6.w
  73:   div r4.x, r4.x, l(8.000000)  // r4.x <- roughnessFactor
...
#line 36
  78:   dp3 r6.w, r12.xyzx, r8.xyzx
  79:   max r6.w, r6.w, l(0.000000)
  80:   min r6.w, r6.w, l(1.000000)  // r6.w <- cosIncidentAngle

#line 38
  81:   mov r6.w, -r6.w
  82:   add r6.w, r6.w, l(1.000000)  // r6.w <- f0

#line 39
  83:   mov r8.xyz, -r9.xyzx
  84:   add r8.xyz, r8.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
  85:   mul r7.w, r6.w, r6.w
  86:   mul r7.w, r6.w, r7.w
  87:   mul r7.w, r6.w, r7.w
  88:   mul r6.w, r6.w, r7.w
  89:   mul r8.xyz, r6.wwww, r8.xyzx
...
#line 52
  93:   mul r8.xyz, r4.xxxx, r8.xyzx  // r8.x <- specAlbedo.x; r8.y <- specAlbedo.y; r8.z <- specAlbedo.z
...
#line 149
  99:   mul r7.xyz, r3.wwww, r7.xyzx
 100:   add r6.xyz, r6.xyzx, r7.xyzx

#line 150
 101:   iadd r2.w, r2.w, l(1)
 102: endloop 
...
#line 120 "C:\cg\DX12\Solution\Chap9\Chap9_Crate\Shaders\Default.hlsl"
...
#line 126
 106: mov r0.w, r0.w  // r0.w <- litColor.w

#line 128
 107: mov o0.xyz, r0.xyzx
 108: mov o0.w, r0.w
 109: ret 
