...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\Chap9_1\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\Chap9_1\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_0");
...
void CrateApp::BuildShapeGeometry()
{
	...
	for(size_t i = 0; i < box.Vertices.size(); ++i)
	{
		...
		vertices[i].TexC = { box.Vertices[i].TexC.x * 5.f,box.Vertices[i].TexC.y * 5.f };
	}
