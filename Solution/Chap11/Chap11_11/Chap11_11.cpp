...
private:
	...
	RenderItem* mReflectedFloor = nullptr;
...
void StencilApp::OnKeyboardInput(const GameTimer& gt)
{
	...
	XMMATRIX floorWorld = R;
	XMStoreFloat4x4(&mReflectedFloor->World, floorWorld);

	mSkullRitem->NumFramesDirty = gNumFrameResources;
	mReflectedSkullRitem->NumFramesDirty = gNumFrameResources;
	mShadowedSkullRitem->NumFramesDirty = gNumFrameResources;
	mReflectedFloor->NumFramesDirty = gNumFrameResources;
}
...
void StencilApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\Chap11_11\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\Chap11_11\\Shaders\\Default.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"..\\Chap11_11\\Shaders\\Default.hlsl", alphaTestDefines, "PS", "ps_5_0");
...
void StencilApp::BuildRenderItems()
{
	...
	*reflectedFloorRitem = *floorRitem;
	...
	mReflectedFloor = reflectedFloorRitem.get();
