...
{
	// Cubic triangular Bezier patch: 10 control points.
	// Index layout (i+j+k=3, barycentric):
	...
	{
		// Corners
		XMFLOAT3(-15.0f,  0.0f, +15.0f),  // [0] P300
		XMFLOAT3(+15.0f,  0.0f, +15.0f),  // [1] P030
		XMFLOAT3(  0.0f,  0.0f, -15.0f),  // [2] P003

		// Edge 0-1 control points
		XMFLOAT3( -5.0f, 15.0f, +15.0f),  // [3] P210
		XMFLOAT3( +5.0f, 15.0f, +15.0f),  // [4] P120

		// Edge 1-2 control points
		XMFLOAT3(+12.0f, 15.0f,   0.0f),  // [5] P021
		XMFLOAT3( +5.0f,  0.0f, -10.0f),  // [6] P012

		// Edge 0-2 control points
		XMFLOAT3( -5.0f,  0.0f, -10.0f),  // [7] P102
		XMFLOAT3(-12.0f, 15.0f,   0.0f),  // [8] P201

		// Interior control point
		XMFLOAT3(  0.0f, 20.0f,   0.0f),  // [9] P111
	};
