...
void ShapesApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	for (int i = 0; i < 5; i++) {
		...
		mMainPassCB.Lights[i].Strength = { 0.7f, 0.7f, 0.7f };
		mMainPassCB.Lights[i].Direction = { 0.0f, 0.0f, 0.0f };


		mMainPassCB.Lights[5 + i].Position = {+5.0f, 3.5f, -10.0f + i * 5.0f};
		mMainPassCB.Lights[5 + i].Strength = { 0.7f, 0.7f, 0.7f };
		mMainPassCB.Lights[5 + i].Direction = { 0.0f, 0.0f, 0.0f };
	}
...
void ShapesApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\Chap8_4\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\Chap8_4\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");
