...
{
	std::ifstream fin("../Chap7_3/skull.txt");
...
void ShapesApp::BuildShapeGeometry()
{
	...
	GeometryGenerator::MeshData box = geoGen.CreateBox(0.0f, 0.0f, 1.5f, 3);
	GeometryGenerator::MeshData grid = geoGen.CreateGrid(0.0f, 0.0f, 60, 40);
	GeometryGenerator::MeshData sphere = geoGen.CreateSphere(0.0f, 20, 20);
    //GeometryGenerator::MeshData sphere = geoGen.CreateGeosphere(0.5f, 3);
	GeometryGenerator::MeshData cylinder = geoGen.CreateCylinder(0.0f, 0.0f, 3.0f, 20, 20);
