...
#include "../Chap10_Blend/FrameResource.h"
#include "../Chap10_Blend/Waves.h"
...
void BlendApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\Chap10_5\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\Chap10_5\\Shaders\\Default.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"..\\Chap10_5\\Shaders\\Default.hlsl", alphaTestDefines, "PS", "ps_5_0");
